...
parser.add_argument('--dataset', type=str, default='ds1', help="iu-xray or mimic-cxr or ds1")
parser.add_argument('--annotation', type=str, default=r'/home/user/Downloads/iu_xray/annotation.json', help="annotation file of the dataset")
parser.add_argument('--base_dir', type=str, default=r'/home/user/Downloads/iu_xray/images', help="base dir to help find images")
...
# ========================= Model Settings ============================
parser.add_argument('--vision_model', default='mask_vit_small_patch16_224', type=str, help="vision model to use")
...
parser.add_argument('--llm_model_name_or_path', default='LinkSoul/Chinese-Llama-2-7b', type=str)
# ======================== SavedModel Configs ===========================
parser.add_argument('--savedmodel_path', type=str, default='save/ds1/v1')
...
parser.add_argument('--strategy', type=str, default="ddp_find_unused_parameters_true", help='default ddp for multi-gpus')
...
parser.add_argument('--max_epochs', type=int, default=50, help='Stop training once this number of epochs is reached')
